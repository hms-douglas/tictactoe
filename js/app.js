...
(function() {
    ...
    class Sound {
        ...
        static #SOUND_CLICK_O = new Audio("tictactoe/audio/sound/o.wav");
        static #SOUND_CLICK_X = new Audio("tictactoe/audio/sound/x.wav")
    ...
    class Music {
        ...
        static #MUSICS = [
            new Audio("tictactoe/audio/music/0.mp3"),
            new Audio("tictactoe/audio/music/1.mp3"),
            new Audio("tictactoe/audio/music/2.mp3"),
            new Audio("tictactoe/audio/music/3.mp3")
        ];
